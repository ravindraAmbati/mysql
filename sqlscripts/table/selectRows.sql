...
select * from users order by age asc limit 1,3;
select * from users order by age asc limit 2,3;
select * from users order by age asc limit 0,1;
select * from users order by age asc limit 1,1;
select * from users order by age asc limit 2,1;
select * from users order by age desc limit 0,3;
select * from users order by age desc limit 1,3;
select * from users order by age desc limit 2,3;
select * from users order by age desc limit 0,1;
